...
const SettingsIcon = () => {
  ...
  const [iconColor, setIconColor] = useState('#000000'); // Default light mode color

  useEffect(() => {
    // Set the icon color based on dark mode state
    if (darkMode) {
      setIconColor('#ffffff'); // Set to white when dark mode is enabled
    } else {
      setIconColor('#000000'); // Set to black when light mode is enabled
    }
  }, [darkMode]);
